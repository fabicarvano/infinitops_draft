...
export default function Tickets() {
  ...
  // Estado para controlar o modal de detalhes do chamado
  ...
  // Funções para o modal de detalhes do chamado
      ...
      <div className="card overflow-hidden mb-6">
        <div className="px-5 py-4 border-b border-slate-100 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h3 className="title text-lg">SLA Próximos do Vencimento</h3>
            <Badge className="ml-3 bg-red-100 text-red-700">{slaExpiringTickets.length}</Badge>
          </div>
          <Button 
            variant="outline" 
            size="sm" 
